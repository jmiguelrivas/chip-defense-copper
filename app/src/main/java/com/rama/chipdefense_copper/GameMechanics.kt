...
import com.rama.chipdefense_copper.gameElements.Wave
...
class GameMechanics {
    companion object Params {
        /** how many stages there are in NORMAL. Must be changed when adding new stages. */
    ...
    fun currentHeroesOnLeave(
        stage: Stage.Identifier,
        leaveStartsOnLevel: Boolean = false
    ...
    fun setSummaryOfStage(stage: Stage.Identifier, summary: Stage.Summary?)
             ...
             * depending on the series (normal, endless)
             */
    {
        summary?.let {
            when (stage.series) {
             ...
             */
    {
        ...
        if (theoreticalAmountOfCoins < 0)
            theoreticalAmountOfCoins =
                0  // more coins have been spent than earned, that is clearly a bug
