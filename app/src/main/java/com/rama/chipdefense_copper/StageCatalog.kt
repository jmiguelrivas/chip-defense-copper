 ...
 */
{
    companion object {
        ...
        {
            var additionalCount =
                stage.gameMechanics.heroModifier(Hero.Type.CREATE_ADDITIONAL_CHIPS).toDouble()
                    ...
                    when (slot.chipData.type) {
                        ...
                        Chip.ChipType.EMPTY -> {
                            Chip.desiredTypes.random().let {
                                ...
                                slot.setType(it)
                                slot.chipData.refund =
                                    GameMechanics.valueOfAutogeneratedChip  // overwrite the standard value of the chip
