 ...
 */
{
    ...
    enum class Type {
        INCREASE_CHIP_SUB_SPEED, INCREASE_CHIP_SUB_RANGE, DOUBLE_HIT_SUB,
    ...
    fun getMaxUpgradeLevel(): Int
             ...
             */
    {
        val additionalUpgradePossibility =
            gameActivity.gameMechanics.heroModifier(Type.INCREASE_MAX_HERO_LEVEL).toInt()
        if (data.type in
    ...
    /** data related to the historical person behind the hero, such as description, photo, cv */
    {
        ...
        fun setType() {
            ...
            try {
                ...
                url =
                    resources.getString(R.string.url_wikipedia_fallback)  // resource doesn't exist
            }
        }
    }
...
//        )
             ...
             * @param duration how many stages the leave will last (including start and end) */
    {
        ...
        gameActivity.gameMechanics.holidays[level.number] =
            Holiday(data.type, level.number, levelTo.number)
